...
* @version $Id: edit_drafts.php 1 2010-11-04 00:22:48Z joeroberts $
...
*/
	$do                                     = request_var('do', '');
                switch($do) {
							...
							if($edit_id == '') $error[] = _btiderror;
							$subject = request_var('subject', '');
							if($subject == '') $error[] = _btpmnosubject;
							$message = request_var('message', '');
							if($message == '') $error[] = _btpmnomessage;
							if (count($error) > 0){
							$errmsg = "<p>"._btalertmsg."</p>\n";
							$errmsg .= "<ul>\n";
							...
							$check = false;
								...
								{
								$template->assign_vars(array('ERROR' => bterror_draft_no));
								break;
								}
