...
if (isset($do) && $do == "savesettings") {
        ...
        header("Location: admin.php?op=searchcloud&saved=1");
        die();
}
echo "<a name=\"cloud\"></a>";
if (isset($saved)) {
...
echo "<form method=\"POST\" action=\"admin.php?op=searchcloud&do=savesettings#cloud\">\n";
...
switch ($op) {
	case "delterm": {
                        ...
                        $sql = "DELETE FROM ".$db_prefix."_search_text WHERE id = '".$id."';";
                                ...
                                echo "<meta http-equiv=\"refresh\" content=\"3;url=admin.php?op=searchcloud#cloud\">";
                                OpenTable2();
...
//Search Form
echo "<form action=\"admin.php#cloud\" method=\"GET\">\n";
...
//Start writing row
	...
	echo pic("drop.gif","admin.php?op=delterm&id=".$row["id"]."#cloud",_admclouddelterm);
        echo"</p></td>";
        echo "</tr>\n";
}
...
$pager = "<a href=\"admin.php?op=searchcloud\">".(($page == 1) ? "<b>1</b>" : "1")."</a>&nbsp;";

if (($page - 15) > 1) $pager .= "...";

for ($i = max(2,$page - 15); $i < min($pages, $page + 15); $i++) {
        $pager .= "<a href=\"admin.php?op=searchcloud&page=".$i."\">".(($i == $page) ? "<b>".$i."</b>" : $i)."</a>&nbsp;";
}

if (($page + 15) < $pages) $pager .= "...";
$pager .= "<a href=\"admin.php?op=searchcloud&page=".$pages."\">".(($page == $pages) ? "<b>".$pages."</b>" : $pages)."</a>";
