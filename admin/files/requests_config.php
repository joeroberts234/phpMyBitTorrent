...
if (isset($_POST['ratio']) AND  $_POST['ratio'] == 'config'){
...
bterror("No error found2.<br /><br /><a href=admin.php?op=requests_config>Back</a>","Settings Updated");
    }
...
bterror("No error found.<br /><br /><a href=admin.php?op=requests_config>Back</a>","Settings Updated");
}
OpenTable('Requests Config');
echo '<form action="admin.php?op=requests_config" method=post>';
