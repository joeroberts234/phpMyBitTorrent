...
bterror("No error found2.<br /><br /><a href=admin.php?op=offers_config>Back</a>","Settings Updated");
    }
...
bterror("No error found.<br /><br /><a href=admin.php?op=offers_config>Back</a>","Settings Updated");
}
OpenTable('Offers Config');
echo '<form action="admin.php?op=offers_config" method=post>';
