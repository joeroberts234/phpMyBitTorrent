...
bterror("No error found2.<br /><br /><a href=modcp.php?op=ratiowarn_config>Back</a>","Settings Updated");
    }
...
bterror("No error found.<br /><br /><a href=modcp.php?op=ratiowarn_config>Back</a>","Settings Updated");
}
OpenTable('Warning Configs');
echo '<form action="modcp.php?op=ratiowarn_config" method=post>';
