...
$leveluser = "";
$res = "SELECT id, username, email FROM ".$db_prefix."_users ".$leveluser.";" or btsqlerror($res);
...
$success = mail($to, $subject, $message, "Od: $from_email", "-f$admin_email");
...
<div align=center>
<form name="formdata" method=post action=modcp.php?op=staffmess&page=pm>
...
<form method=post action=modcp.php?op=staffmess&page=mail>
...
adminentry("massmail","staffmess&page=sendmail",_admmassmail);
$op_keys = explode(",","massmail");
adminentry("massmail","staffmess&page=sendpm",_admmasspm);
