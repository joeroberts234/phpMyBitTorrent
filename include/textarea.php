...
class textarea {
				...
				function quick_smilies($area = 'descr',$return = 'forumdata')
				{
                        ...
                        foreach ($smile_rows as $smile) {
                             $q_smile .= "<a onclick=\"comment_smile('".$smile["code"]."',".$return.".".$area.");\"><img src=\"./smiles/".$smile["file"]."\" border=\"0\" alt=\"".$smile["alt"]."\"></a>\n";
                             }
                         }
				...
				function quick_bbcode($return,$area)
				{
                        ...
                        <img src=images/bold.gif alt=Bold&nbsp;Text Text title=Bold&nbsp;Text Text border=0 onclick=bbcode(document." . $return .",'b',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/italic.gif alt=Italic&nbsp;Text Text title=Italic&nbsp;Text Text border=0 onclick=bbcode(document." . $return .",'i',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/underline.gif alt=Underlined&nbsp;Text Text title=Underlined&nbsp;Text Text border=0 onclick=bbcode(document." . $return .",'u',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/justifycenter.gif alt=Center&nbsp;Text Text title=Centerd&nbsp;Text Text border=0 onclick=bbcode(document." . $return .",'center',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/link.gif alt=Add&nbsp;Link einf&uuml;gen title=Add&nbsp;Link einf&uuml;gen border=0 onclick=namedlink(document." . $return .",'url'," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/image.gif alt=Insert&nbsp;Image einf&uuml;gen title=Insert&nbsp;Image einf&uuml;gen border=0 onclick=bbcode(document." . $return .",'img','http://'," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/copy.gif alt=Insert&nbsp;Quote einf&uuml;gen title=Insert&nbsp;Quote einf&uuml;gen border=0 onclick=bbcode(document." . $return .",'quote','',".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/unorderedlist.gif alt=Add&nbsp;List title=Add&nbsp;List erstellen border=0 onclick=dolist(document." . $return .",".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/source.gif alt=Insert&nbsp;Code einf&uuml;gen title=Insert&nbsp;Code einf&uuml;gen border=0 onclick=bbcode(document." . $return .",'code',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; />
                        <img src=images/textfield.gif alt=Insert&nbsp;Syntax&nbsp;Highlighted&nbsp;PHP&nbsp;CODE title=Insert&nbsp;Syntax&nbsp;Highlighted&nbsp;PHP&nbsp;CODE border=0 onclick=bbcode(document." . $return .",'php',''," . $return .".".$area.") onmouseover=this.style.cursor='pointer'; /></td></tr><tr><td align=center>";
                                #Smiles
