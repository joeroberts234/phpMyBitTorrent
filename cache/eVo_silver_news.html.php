...
<div class="cap-left">
<div class="cap-right">
<a class="c4" style="cursor: pointer;float:left;" onclick="toggle2('nnSite_News');"><img title="Expand item" id="nnSite_Newsimg" src="themes/eVo_silver/pics/minus.gif"  alt="+"></a>Site News
</div>
</div>
</div>
