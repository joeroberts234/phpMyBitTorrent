...
document.getElementById(nome+"img").src="themes/eVo_red/pics/minus.gif";
} else {
SetCookie(nome,'none',200);
document.getElementById(nome).style.display = 'none';
document.getElementById(nome+"img").src="themes/eVo_red/pics/plus.gif";
}
}
...
<link REL="shortcut icon" HREF="http://p2p-evolution.com/themes/eVo_red/favicon.ico" TYPE="image/x-icon">
...
<link rel="StyleSheet" href="<?php echo (isset($this->_rootref['SITE_URL'])) ? $this->_rootref['SITE_URL'] : ''; ?>/themes/eVo_red/style.css" type="text/css">
...
<!--[if lt IE 7]><link rel="stylesheet" type="text/css" media="screen" href="themes/eVo_red/iestyle.css">
<![endif]-->
<!--[if IE]>
<link rel="stylesheet" type="text/css" media="screen" href="themes/eVo_red/iestyle.css">
<![endif]-->
...
<a href="index.php" ><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_home.gif" border="0" alt="" title="Home" id="home"></a>
<a id="myAnchor" href="torrents.php" onclick="do_breload();"><img onclick="do_breload();" onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_browse.gif" border="0" alt="" title="Browse" id="browse"></a>
...
<a href="pm.php"><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_messages.gif" border="0" alt="mess" title="Messages" id="msg"></a>
<a href="upload.php"><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_upload.gif" border="0" alt="" title="Upload" id="upload"></a>
<a href="forums.php"><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_forum.gif" border="0" alt="" title="Forums" id="forums"></a>
<span class="overlib" onclick="return overlib('<table width=\'100%\' cellspacing=\'1\' cellpadding=\'4\' border=\'0\' class=\'tableinborder\'><tr><td class=\'tabletitle\'><div align=\'center\'><a href=\'javascript:;\' onclick=\'return nd();\'>Help Menu</a></div></td></tr><tr><td class=\'tableb\'><div align=\'center\'><a href=\'rules.php\'>Rules</a></div></td></tr><tr><td class=\'tableb\'><div align=\'center\'><a href=\'faq.php\'>F.A.Q</a></div></td></tr><tr><td class=\'tableb\'><div align=\'center\'><a href=\'staff.php\'>Staff</a></div></td></tr></table>',CELLPAD,'0',FOLLOWMOUSE,'0',TEXTFONT,'Verdana',TEXTCOLOR,'#FFFFFF',CAPTIONFONT,'Lucida Console, Verdana',CENTER,FGCOLOR,'#000000',BGCOLOR,'#6F7578',CAPICON,'themes/eVo_red/pics/help.png',SHADOW,SHADOWOPACITY,40,SHADOWCOLOR,'#030303',SHADOWX,2,SHADOWY,2);"  ><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_help.gif" border="0" alt="" title="Staff" id="help"></span>
<a onclick="if(!confirm('Are you sure do you want to logout?')){return false;};" href="user.php?op=logout" r="0" alt="" title="Logout"><img onmouseover="change_bg(this,'1')" onmouseout="change_bg(this,'0')" src="themes/eVo_red/pics/top_logout.gif" border="0" title="Logout" alt="" id="logout"></a>
</td>
</tr>
<tr>
<td id="contentrow">
		...
		<td class="row1" align="center">
			...
			<table border="0" cellpadding="2" cellspacing="1">
				...
				<td align="center"><img src="/images/<?php echo (isset($this->_rootref['CP_ONLINE'])) ? $this->_rootref['CP_ONLINE'] : ''; ?>line.png" alt="<?php echo (isset($this->_rootref['CP_ONLINE'])) ? $this->_rootref['CP_ONLINE'] : ''; ?>line" title="<?php echo (isset($this->_rootref['CP_ONLINE'])) ? $this->_rootref['CP_ONLINE'] : ''; ?>line"></td>
					...
					<td class="genmed" align="center">[ <a href="user.php?op=profile&amp;id=<?php echo (isset($this->_rootref['CP_UID'])) ? $this->_rootref['CP_UID'] : ''; ?>&amp;mode=switch_perm&amp;u=<?php echo (isset($this->_rootref['CP_UCAN_DO'])) ? $this->_rootref['CP_UCAN_DO'] : ''; ?>">Test out user’s permissions</a> ]</td>
				</tr><?php } ?>
							<tr>
...
<a class="c4" style="cursor: pointer; float: left;" onclick="toggle2('nn ');"><img title="Expand item" id="nn&nbsp;img" src="themes/eVo_red/pics/minus.gif" alt="+"></a><?php echo ((isset($this->_rootref['L__btpersonal'])) ? $this->_rootref['L__btpersonal'] : ((defined('_btpersonal')) ? _btpersonal : '{ _btpersonal }')); ?>
</div>
</div>
</div>
...
<td class="colhead" align="right"><img src="themes/eVo_red/pics/completed.gif" alt="Number of Files" title="Number of Files" border="0"></td>
<td class="colhead" align="right"><img src="themes/eVo_red/pics/comments.png" alt="Comments" title="Comments" border="0"></td>
<td class="colhead" align="center"><img src="themes/eVo_red/pics/report.gif" alt="Ratings" title="Ratings" border="0"></td>
<td class="colhead" align="center">Uploaded</td>
<td class="colhead" align="center"><img src="themes/eVo_red/pics/completion.gif" alt="AVG Speed" title="AVG Speed" border="0"></td>
<td class="colhead" align="center"><img src="themes/eVo_red/pics/servers.png" alt="Size" title="Size" border="0"></td>
<td class="colhead" align="center"><img src="themes/eVo_red/pics/completed.png" alt="Downloaded" title="Downloaded" border="0"></td>
<td class="colhead" align="right"><img src="themes/eVo_red/pics/seeders.png" alt="Seeds" title="Seeds" border="0"></td>
<td class="colhead" align="right"><img src="themes/eVo_red/pics/leechers.png" alt="Leechers" title="Leechers" border="0"></td>
<td class="colhead" align="center"><img src="themes/eVo_red/pics/peers.gif" alt="addedby" title="addedby" border="0"></td>
</tr>
...
<td align="left">
  <nobr>
    <p class="title">
	   <nobr>
      <?php if ($_torrent_varmyu_val['NUKED']) {  ?><img src="themes/eVo_red/pics/nuked.gif" alt="NUKED TORRENT" title="NUKED TORRENT" border="0"><?php } if ($_torrent_varmyu_val['FREE_DL']) {  ?><img src="themes/eVo_red/pics/magic.gif" alt="FREE TORRENT" title="FREE TORRENT" border="0"><?php } if (! $_torrent_varmyu_val['LOCAL_T']) {  ?><img src="themes/eVo_red/pics/external.gif" alt="External Tracker" title="External Tracker" border="0"><?php } if ($_torrent_varmyu_val['DHT_INABLED']) {  ?><span class="overlib" onmouseover="return overlib('This torrent supports DHT. With a state-of-the-art client, you\'ll be able to download this torrent even if a central tracker goes down.',CAPTION, 'DHT Support',TEXTFONT,'Verdana',TEXTCOLOR,'#FFFFFF',CAPTIONFONT,'Lucida Console, Verdana',LEFT,FGCOLOR,'#000000',BGCOLOR,'#6F7578',CAPICON,'themes/eVo_red/pics/help.gif',BORDER,2,SHADOW,SHADOWOPACITY,40,SHADOWCOLOR,'#030303',SHADOWX,2,SHADOWY,2);" onmouseout="return nd();" style="cursor: help;">
	  <img src="themes/eVo_red/pics/dht.gif" alt="" title="" border="0"></span><?php } ?>
	  <br />
	  ...
	  </nobr></p><?php if ($_torrent_varmyu_val['CAN_DOWN_LOAD']) {  ?><a class="index" href="download.php?id=<?php echo $_torrent_varmyu_val['ID']; ?>"><img style="border: medium none ;" alt="download" src="themes/eVo_red/pics/download2.gif" align="right"></a><?php } ?>

	  </nobr><br>
	  <?php if ($_torrent_varmyu_val['BANNED']) {  ?><img src="themes/eVo_red/pics/banned.png" alt="Banned torrent" title="Banned torrent" border="0"><?php } if ($_torrent_varmyu_val['CAN_EDIT']) {  ?><a href="edit.php?id=<?php echo $_torrent_varmyu_val['ID']; ?>"><img src="themes/eVo_red/pics/edit.gif" alt="Edit" title="Edit" border="0"></a><?php } if ($_torrent_varmyu_val['CAN_DEL']) {  ?><a href="edit.php?op=delete&amp;id=<?php echo $_torrent_varmyu_val['ID']; ?>"><img src="themes/eVo_red/pics/drop.gif" alt="Delete" title="Delete" border="0"></a><?php } if ($_torrent_varmyu_val['CAN_BAN']) {  ?><a href="edit.php?op=ban&amp;id=<?php echo $_torrent_varmyu_val['ID']; ?>"><img src="themes/eVo_red/pics/ban.png" alt="Ban Torrent" title="Ban Torrent" border="0"></a><?php } if (! $_torrent_varmyu_val['LOCAL_T']) {  if ($_torrent_varmyu_val['REFRESH_T']) {  ?><a href="scrape-external.php?id=<?php echo $_torrent_varmyu_val['ID']; ?>&amp;tracker=&amp;return=%2Ftemplate_test.php"><img src="themes/eVo_red/pics/refresh.png" alt="Refresh Peer Data" title="Refresh Peer Data" border="0"></a>
	  <?php } else { ?><img src="themes/eVo_red/pics/refresh_gray.png" alt="Stats Updated less than 30min ago" title="Stats Updated less than 30min ago" border="0"><?php } if ($_torrent_varmyu_val['NEED_AUTH']) {  echo $_torrent_varmyu_val['AUTH_LINK']; } } ?>
	  <br>
	  <span id="ID<?php echo $_torrent_varmyu_val['ID']; ?>">
	  <a onclick="sndReq('op=view_details&amp;torrent=<?php echo $_torrent_varmyu_val['ID']; ?>', 'ID<?php echo $_torrent_varmyu_val['ID']; ?>')"><img src="themes/eVo_red/pics/plus.gif" alt="Torrent Details" title="Torrent Details" border="0"></a>
	  </span>
</td>
...
<a class="c4" style="cursor: pointer; float: left;" onclick="toggle2('nn ');"><img title="Expand item" id="nn&nbsp;img" src="themes/eVo_red/pics/minus.gif" alt="+"></a><?php echo ((isset($this->_rootref['L__btseedby'])) ? $this->_rootref['L__btseedby'] : ((defined('_btseedby')) ? _btseedby : '{ _btseedby }')); ?>;
</div>
</div>
</div>
</td></tr><tr valign="middle">
...
<td align="left">
  <nobr>
    <p class="title">
	   <nobr>
      <?php if ($_torrent_varmys_val['NUKED']) {  ?><img src="themes/eVo_red/pics/nuked.gif" alt="NUKED TORRENT" title="NUKED TORRENT" border="0"><?php } if ($_torrent_varmys_val['FREE_DL']) {  ?><img src="themes/eVo_red/pics/magic.gif" alt="FREE TORRENT" title="FREE TORRENT" border="0"><?php } if (! $_torrent_varmys_val['LOCAL_T']) {  ?><img src="themes/eVo_red/pics/external.gif" alt="External Tracker" title="External Tracker" border="0"><?php } if ($_torrent_varmys_val['DHT_INABLED']) {  ?><span class="overlib" onmouseover="return overlib('This torrent supports DHT. With a state-of-the-art client, you\'ll be able to download this torrent even if a central tracker goes down.',CAPTION, 'DHT Support',TEXTFONT,'Verdana',TEXTCOLOR,'#FFFFFF',CAPTIONFONT,'Lucida Console, Verdana',LEFT,FGCOLOR,'#000000',BGCOLOR,'#6F7578',CAPICON,'themes/eVo_red/pics/help.gif',BORDER,2,SHADOW,SHADOWOPACITY,40,SHADOWCOLOR,'#030303',SHADOWX,2,SHADOWY,2);" onmouseout="return nd();" style="cursor: help;">
	  <img src="themes/eVo_red/pics/dht.gif" alt="" title="" border="0"></span><?php } ?>
	  <br />
	  ...
	  </nobr></p><?php if ($_torrent_varmys_val['CAN_DOWN_LOAD']) {  ?><a class="index" href="download.php?id=<?php echo $_torrent_varmys_val['ID']; ?>"><img style="border: medium none ;" alt="download" src="themes/eVo_red/pics/download2.gif" align="right"></a><?php } ?>

	  </nobr><br>
	  <?php if ($_torrent_varmys_val['BANNED']) {  ?><img src="themes/eVo_red/pics/banned.png" alt="Banned torrent" title="Banned torrent" border="0"><?php } if ($_torrent_varmys_val['CAN_EDIT']) {  ?><a href="edit.php?id=<?php echo $_torrent_varmys_val['ID']; ?>"><img src="themes/eVo_red/pics/edit.gif" alt="Edit" title="Edit" border="0"></a><?php } if ($_torrent_varmys_val['CAN_DEL']) {  ?><a href="edit.php?op=delete&amp;id=<?php echo $_torrent_varmys_val['ID']; ?>"><img src="themes/eVo_red/pics/drop.gif" alt="Delete" title="Delete" border="0"></a><?php } if ($_torrent_varmys_val['CAN_BAN']) {  ?><a href="edit.php?op=ban&amp;id=<?php echo $_torrent_varmys_val['ID']; ?>"><img src="themes/eVo_red/pics/ban.png" alt="Ban Torrent" title="Ban Torrent" border="0"></a><?php } if (! $_torrent_varmys_val['LOCAL_T']) {  if ($_torrent_varmys_val['REFRESH_T']) {  ?><a href="scrape-external.php?id=<?php echo $_torrent_varmys_val['ID']; ?>&amp;tracker=&amp;return=%2Ftemplate_test.php"><img src="themes/eVo_red/pics/refresh.png" alt="Refresh Peer Data" title="Refresh Peer Data" border="0"></a>
	  <?php } else { ?><img src="themes/eVo_red/pics/refresh_gray.png" alt="Stats Updated less than 30min ago" title="Stats Updated less than 30min ago" border="0"><?php } if ($_torrent_varmys_val['NEED_AUTH']) {  echo $_torrent_varmys_val['AUTH_LINK']; } } ?>
	  <br>
	  <span id="ID<?php echo $_torrent_varmys_val['ID']; ?>">
	  <a onclick="sndReq('op=view_details&amp;torrent=<?php echo $_torrent_varmys_val['ID']; ?>', 'ID<?php echo $_torrent_varmys_val['ID']; ?>')"><img src="themes/eVo_red/pics/plus.gif" alt="Torrent Details" title="Torrent Details" border="0"></a>
	  </span>
</td>
...
<a class="c4" style="cursor: pointer; float: left;" onclick="toggle2('nn ');"><img title="Expand item" id="nn&nbsp;img" src="themes/eVo_red/pics/minus.gif" alt="+"></a><?php echo ((isset($this->_rootref['L__btleechby'])) ? $this->_rootref['L__btleechby'] : ((defined('_btleechby')) ? _btleechby : '{ _btleechby }')); ?>;
</div>
</div>
</div>
</td></tr><tr valign="middle">
...
<td align="left">
  <nobr>
    <p class="title">
	   <nobr>
      <?php if ($_torrent_varmyl_val['NUKED']) {  ?><img src="themes/eVo_red/pics/nuked.gif" alt="NUKED TORRENT" title="NUKED TORRENT" border="0"><?php } if ($_torrent_varmyl_val['FREE_DL']) {  ?><img src="themes/eVo_red/pics/magic.gif" alt="FREE TORRENT" title="FREE TORRENT" border="0"><?php } if (! $_torrent_varmyl_val['LOCAL_T']) {  ?><img src="themes/eVo_red/pics/external.gif" alt="External Tracker" title="External Tracker" border="0"><?php } if ($_torrent_varmyl_val['DHT_INABLED']) {  ?><span class="overlib" onmouseover="return overlib('This torrent supports DHT. With a state-of-the-art client, you\'ll be able to download this torrent even if a central tracker goes down.',CAPTION, 'DHT Support',TEXTFONT,'Verdana',TEXTCOLOR,'#FFFFFF',CAPTIONFONT,'Lucida Console, Verdana',LEFT,FGCOLOR,'#000000',BGCOLOR,'#6F7578',CAPICON,'themes/eVo_red/pics/help.gif',BORDER,2,SHADOW,SHADOWOPACITY,40,SHADOWCOLOR,'#030303',SHADOWX,2,SHADOWY,2);" onmouseout="return nd();" style="cursor: help;">
	  <img src="themes/eVo_red/pics/dht.gif" alt="" title="" border="0"></span><?php } ?>
	  <br />
	  ...
	  </nobr></p><?php if ($_torrent_varmyl_val['CAN_DOWN_LOAD']) {  ?><a class="index" href="download.php?id=<?php echo $_torrent_varmyl_val['ID']; ?>"><img style="border: medium none ;" alt="download" src="themes/eVo_red/pics/download2.gif" align="right"></a><?php } ?>

	  </nobr><br>
	  <?php if ($_torrent_varmyl_val['BANNED']) {  ?><img src="themes/eVo_red/pics/banned.png" alt="Banned torrent" title="Banned torrent" border="0"><?php } if ($_torrent_varmyl_val['CAN_EDIT']) {  ?><a href="edit.php?id=<?php echo $_torrent_varmyl_val['ID']; ?>"><img src="themes/eVo_red/pics/edit.gif" alt="Edit" title="Edit" border="0"></a><?php } if ($_torrent_varmyl_val['CAN_DEL']) {  ?><a href="edit.php?op=delete&amp;id=<?php echo $_torrent_varmyl_val['ID']; ?>"><img src="themes/eVo_red/pics/drop.gif" alt="Delete" title="Delete" border="0"></a><?php } if ($_torrent_varmyl_val['CAN_BAN']) {  ?><a href="edit.php?op=ban&amp;id=<?php echo $_torrent_varmyl_val['ID']; ?>"><img src="themes/eVo_red/pics/ban.png" alt="Ban Torrent" title="Ban Torrent" border="0"></a><?php } if (! $_torrent_varmyl_val['LOCAL_T']) {  if ($_torrent_varmyl_val['REFRESH_T']) {  ?><a href="scrape-external.php?id=<?php echo $_torrent_varmyl_val['ID']; ?>&amp;tracker=&amp;return=%2Ftemplate_test.php"><img src="themes/eVo_red/pics/refresh.png" alt="Refresh Peer Data" title="Refresh Peer Data" border="0"></a>
	  <?php } else { ?><img src="themes/eVo_red/pics/refresh_gray.png" alt="Stats Updated less than 30min ago" title="Stats Updated less than 30min ago" border="0"><?php } if ($_torrent_varmyl_val['NEED_AUTH']) {  echo $_torrent_varmyl_val['AUTH_LINK']; } } ?>
	  <br>
	  <span id="ID<?php echo $_torrent_varmyl_val['ID']; ?>">
	  <a onclick="sndReq('op=view_details&amp;torrent=<?php echo $_torrent_varmyl_val['ID']; ?>', 'ID<?php echo $_torrent_varmyl_val['ID']; ?>')"><img src="themes/eVo_red/pics/plus.gif" alt="Torrent Details" title="Torrent Details" border="0"></a>
	  </span>
</td>
