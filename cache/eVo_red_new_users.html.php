<?php if (!defined('IN_PMBT')) exit; ?>  <table class="tablebg" width="100%" cellspacing="0">
    <tr>
      ...
      <div class="caption">
       <div class="cap-left">
        <div class="cap-right">
         <a class="c4" style="cursor: pointer; float: left;" onclick="toggle2('nnNewest_Members');"><img title="Expand item" id="nnNewest_Membersimg" src="themes/eVo_red/pics/minus.gif" alt="+"></a>Newest Members
       </div>
      </div>
</div>
