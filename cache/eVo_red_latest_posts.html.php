<?php if (!defined('IN_PMBT')) exit; ?><link href="./themes/eVo_red/forums/style.css" rel="stylesheet" type="text/css" media="screen, projection" />
...
<div class="cap-right">
<a class="c4" style="cursor: pointer;float:left;" onclick="toggle2('nnRecent_Posts');"><img title="Expand item" id="nnRecent_Postsimg" src="themes/eVo_red/pics/minus.gif"  alt="+"></a>Recent Posts
</div>
</div>
</div>
</td>
