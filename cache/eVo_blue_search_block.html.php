...
<div class="cap-left">
<div class="cap-right">
<a class="c4" style="cursor: pointer; float: left;" onclick="toggle2('nnSearch');"><img title="Expand item" id="nnSearchimg" src="themes/eVo_blue/pics/minus.gif" alt="+"></a><img src="themes/eVo_blue/pics/icon_mini_search.gif" alt="" title="" border="0">Search
</div>
</div>
</div>
...
<?php $_cats_var_count = (isset($this->_tpldata['cats_var'])) ? sizeof($this->_tpldata['cats_var']) : 0;if ($_cats_var_count) {for ($_cats_var_i = 0; $_cats_var_i < $_cats_var_count; ++$_cats_var_i){$_cats_var_val = &$this->_tpldata['cats_var'][$_cats_var_i]; ?>
      <td class="nopad" style="padding-bottom: 2px; padding-left: 7px;"><?php echo $_cats_var_val['IMAGE']; ?>&nbsp;&nbsp;<input id="checkAll<?php echo $_cats_var_val['ID']; ?>" onclick="checkAllFields(1,<?php echo $_cats_var_val['TABLETYPE']; ?>);" type="checkbox"><a href="javascript: ShowHideMainSubCats(<?php echo $_cats_var_val['TABLETYPE']; ?>,<?php echo (isset($this->_rootref['NCATS_VAR'])) ? $this->_rootref['NCATS_VAR'] : ''; ?>)"><img src="themes/eVo_blue/pics/plus.gif" id="pic<?php echo $_cats_var_val['ID']; ?>" alt="Show/Hide" border="0">&nbsp;<?php echo $_cats_var_val['NAME']; ?></a>&nbsp;</td>
<?php }} ?>
    </tr>
  </tbody>
</table>
