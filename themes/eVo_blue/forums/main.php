...
echo "<table align=center cellpadding=0 cellspacing=0 style='border-collapse: collapse; border-left: solid 2px #004B73; border-right: solid 2px #004B73; border-top: solid 2px #3C3C3C; border-bottom: solid 2px #131313;'  width=100% border=1><tr><td><table  width='100%' cellspacing='5' border=0 class = fheader ><tr><td><a href='forums.php'>Welcome to our Forums</a></td><td align='right'>";
if(checkaccess("modforum"))echo"[ <a href=admin-forums.php>Administration Control Panel</a> ]&nbsp;&nbsp;";
...
global $user,$db, $db_prefix;
	...
	print("<table align=center cellpadding=1 cellspacing=0 style='border-collapse: collapse; border-left: solid 2px #004B73; border-right: solid 2px #004B73; border-top: solid 2px #3C3C3C; border-bottom: solid 2px #131313;'  width=100% border=1 >\n");
	?>
	<tr>
...
function stdhead($title = '', $width = '')
{
	...
	<caption><div class=\"cap-left\"><div class=\"cap-right\">&nbsp;".$title."&nbsp;</div></div></caption>";
