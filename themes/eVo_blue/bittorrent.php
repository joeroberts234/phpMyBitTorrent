...
echo"<td align=\"left\">";
        ...
        echo "<nobr><p class=\"title\"><a STYLE=\"text-decoration:none\" href=\"details.php?id=".$id;
                ...
                if ((checkaccess("download")) AND $row["type"] != "link") echo"<a class=\"index\" href=\"download.php?id=".$row["id"]."\"><img style=\"border: medium none ;\" alt=\"download\" src=\"themes/$theme/pics/download2.gif\" align=\"right\">";
echo"</nobr></a>";
